...
-- ==========================================================
--            1) Calcular total de hospedaje
-- ==========================================================
CREATE OR REPLACE FUNCTION calcular_total_hospedaje(p_id_reservacion INT)
RETURNS NUMERIC AS $$
DECLARE
    precio NUMERIC;
    noches INT;
...
-- ==========================================================
--        2) Calcular total de servicios consumidos
-- ==========================================================
CREATE OR REPLACE FUNCTION calcular_total_servicios(p_id_reservacion INT)
RETURNS NUMERIC AS $$
DECLARE
    total NUMERIC;
BEGIN
...
-- ==========================================================
--      3) Calcular total final (hospedaje + servicios)
-- ==========================================================
CREATE OR REPLACE FUNCTION calcular_total_final(p_id_reservacion INT)
RETURNS NUMERIC AS $$
BEGIN
    RETURN 
...
-- ==========================================================
CREATE OR REPLACE PROCEDURE generar_factura(p_id_reservacion INT, p_id_empleado INT)
LANGUAGE plpgsql
AS $$
DECLARE
    subtotal NUMERIC;
